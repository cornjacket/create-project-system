...
project/tasks/scripts/set-field.sh --epic main --folder backlog --name my-task \
...
project/tasks/scripts/list-tasks.sh --epic main --folder backlog --worktree task-tooling
