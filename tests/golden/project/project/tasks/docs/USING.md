...
project/tasks/scripts/list-tasks.sh --folder backlog --tag docs
...
project/tasks/scripts/set-field.sh --folder backlog --name a3f2c1-my-feature \
...
names declared in `project/tasks/worktrees.md`; `unclassified` is always
accepted.
...
```bash
project/tasks/scripts/new-user-task.sh --folder draft --name my-feature --worktree docs
project/tasks/scripts/list-tasks.sh --folder backlog --worktree docs
project/tasks/scripts/list-tasks.sh --folder backlog --group-by-worktree --sort-priority
```
