...
```
project/
    tasks/    # task management — what needs to be done
...
complete, wont-do). Managed via the scripts in `project/tasks/scripts/`.

Full documentation: `project/tasks/docs/USING.md`.
...
up where the last session left off. See `project/status/README.md`.
